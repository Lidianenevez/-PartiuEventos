...
<section id="speakers-details" style="margin-top:100px" class="wow fadeInUp" >
    ...
    @if (session('msg_danger'))
		...
		@endif
    <form method="POST" class="col-md-8" action="{{ route('evento.update', $e->id) }}" enctype="multipart/form-data">
      @method('PUT')
			@csrf
      ...
      <div class="form-row">
          ...
          <input id="nome_evento" type="text" value="{{ $e->nome_evento }}" placeholder="Digite o nome do evento" class="form-control" name="nome_evento" value="{{ old('nome_evento') }}">
      ...
      <button type="submit" class="btn btn2">Editar</button>
    </form>
	</div>
</section>
@endsection