            ...
            @foreach ($evento as $e)
             <center>
              <div class="row schedule-item">
                <div class="col-md-4">
                  <div class="social">
                    <a  data-toggle="tooltip" data-placement="bottom" title="{{ $e->city['nome'] }}-{{ $e->city['uf'] }}"><i class="fa fa-map-marker"  style="color: #f82249" aria-hidden="true"></i></a>
                    <a  data-toggle="tooltip" data-placement="bottom" title="{{ date('d/m/Y', strtotime($e->datetime['data_inicio'])) }}"><i class="fa fa-calendar"  style="color: #f82249" aria-hidden="true"></i>
                    <a  data-toggle="tooltip" data-placement="bottom" title="{{ date('H:i:s', strtotime($e->datetime['hora_inicio'])) }}"><i class="fa fa-clock-o"  style="color: #f82249"aria-hidden="true"></i></a>
                </div>
              </div>
                <div class="col-md-8">
